...
class SurfaceController():
    ...
    def __init__(self, w, h, color):
        ...
        if self.fullscreen == True:
            self.window_surface = pygame.display.set_mode((w, h), pygame.FULLSCREEN)
        else:
    ...
    def rebuild_window_surface(self):
        ...
        if self.fullscreen == True:
            self.window_surface = pygame.display.set_mode(res, pygame.FULLSCREEN)
        else:
